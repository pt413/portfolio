      ...
      <div className="flex min-h-0 flex-col gap-y-8">
        <div className="flex flex-col items-center justify-center gap-y-4">
          ...
          <div className="flex flex-col items-center justify-center gap-y-3">
            ...
            <p className="text-balance text-center text-muted-foreground md:text-lg/relaxed">
              Projects demonstrating production AI workflows, vector search,
              backend orchestration, and applied machine learning.
            </p>
          </div>
        </div>

        {/* Breaks out of the narrow page container */}
        <div
          className="
            relative
            left-1/2
